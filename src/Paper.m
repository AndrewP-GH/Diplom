...
QH = zeros(Nt,Nx);      %тут будут хранитьс€ значени€ q_2 в каждый момент времени
Control = zeros(2,Nt);  %тут будут хранитьс€ управлени€ в точках i_1 и i_2
